    ...
    class VideosController < ApplicationController
      ...
      def swfupload
        ...
        if @video.save && @video.encode!(test)
          ...
          video = @attachment.to_objs.first
          #render json: @attachment.merge(video.video_url)
          render :json => JSON::parse(@attachment.to_json).merge("video_url" => video.video_url, "video" => video).to_json
