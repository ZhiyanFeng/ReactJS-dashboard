class ContactDump < ActiveRecord::Base
  ...
  def process(phone_numbers, user_id, first_name, last_name, emails, social_links)
  	numbers = phone_numbers.delete('\"').split(',')
  	numbers.each do |number|
  		if User.exists?(:id => user_id) && !([1,6307,6321,6327,1112,134,1140,1139,1115,1141].include? user_id)
