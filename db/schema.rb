...
ActiveRecord::Schema.define(version: 20160306200357) do
  ...
  create_table "admin_claims", force: true do |t|
    t.integer  "user_id"
    t.integer  "ref_type"
    t.integer  "ref_id"
    t.string   "email"
  ...
  create_table "contact_dumps", force: true do |t|
    t.integer  "user_id"
  ...
  create_table "flash_message_responses", force: true do |t|
    t.integer  "user_id"
  ...
  create_table "processed_contact_dumps", force: true do |t|
    t.string   "phone_number"
  ...
  create_table "referral_accepts", force: true do |t|
  ...
  create_table "referral_sends", force: true do |t|
    t.integer  "sender_id"
    t.string   "program_code"
  ...
  create_table "sms_stops", force: true do |t|
