...
=======
ActiveRecord::Schema.define(version: 20150620033113) do
>>>>>>> sandbox
...
=======
  ...
  create_table "subscriptions", force: true do |t|
    ...
    t.string   "feed_frequency",                          null: false
    t.string   "feed_profile_id"
    t.integer  "owner_id",                default: 0
    t.integer  "user_id",                                 null: false
    t.integer  "member_count",            default: 0
    t.string   "feed_nickname"
    t.string   "feed_my_alias"
    t.boolean  "feed_stick_to_top",       default: false
    t.boolean  "feed_mute_notifications", default: false
    t.boolean  "feed_display_nicknames",  default: true
    t.boolean  "is_public",               default: true
    t.boolean  "is_valid",                default: true
    t.datetime "created_at"
    t.datetime "updated_at"
