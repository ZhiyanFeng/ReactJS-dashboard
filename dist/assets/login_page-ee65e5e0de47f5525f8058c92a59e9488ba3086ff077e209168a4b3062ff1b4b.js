    ...
    return {
        ...
        blockUI: function(options) {
            ...
            if (options.animate) {
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="https://s3.amazonaws.com/coffeemobile/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="https://s3.amazonaws.com/coffeemobile/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function(options) {
            if (options && options.animate) {
                ...
                $('.page-loading').remove();
                $('body').append('<div class="page-loading"><img src="https://s3.amazonaws.com/coffeemobile/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (options && options.message ? options.message : 'Loading...') + '</span></div>');
            }
        },
...
var Login = function() {
    ...
    var handleLogin = function() {
        ...
        $('.login-form').validate({
            ...
            submitHandler: function(form) {
                if($('.login-form input').validate().form()) {
    ...
    var handleForgetPassword = function() {
        $('.forget-form').validate({
            ...
            submitHandler: function(form) {
                if($('.forget-form input').validate().form()) {
                    form.submit();
                }
            }
        });
    ...
    var handleRegister = function() {
        ...
        $('.register-form').validate({
            ...
            submitHandler: function(form) {
                if($('.register-form input').validate().form()) {
                    form.submit();
                }
            }
        });
    ...
    var handleResetForm = function() {
        $('.edit-password-form').validate({
            ...
            messages: {
                ...
                rpassword: {
                    ...
                    equalTo: "Sorry, the two passwords do not match."
                }
            },

            invalidHandler: function(event, validator) { //display error alert on form submit   
                $('.alert-danger', $('.edit-password-form')).show();
            },
            ...
            submitHandler: function(form) {
                //form.submit(); // form validation success, call ajax form submit
                if($('.edit-password-form input').validate().form()) {
                    var pid = $("#reset_id").val();
                    //$('.edit-password-form').submit();
                    $.ajax({
                        type: "PUT",
                        url: "/password_resets/" + pid,
                        dataType: "json",
                        data: {
                            "password": $("#register_password").val()
                        },
                        success: function (data) {
                            if(data.eXpresso.code == 1) {
                                window.location.href = "/password_resets_complete";
                            }
                        },
                        error: function(e) { 
                            console.log(e); 
        ...
        $('.edit-password-form input').keypress(function(e) {
            if (e.which == 13) {
                if ($('.edit-password-form').validate().form()) {
                    $('.edit-password-form').submit(); //form validation success, call ajax form submit
                }
                return false;
            }
        });
