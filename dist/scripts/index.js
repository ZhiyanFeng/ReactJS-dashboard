        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: 'Explore and see how Coffee Enterprise can improve employee connectivity, productivity and build your company culture.',
                    // (string | optional) the image to display on the left
                    image: '/assets/img/coffee-badge.png',
