...
var _s3Upload = require('./s3Upload');
...
exports.default = function _callee(_ref) {
  ...
  var s3, files, spinner, i, file, stream, stats, contentType, fileName, size;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 11:
          ...
          _context.next = 21;
          return _regenerator2.default.awrap((0, _s3Upload2.default)(s3, {
            Bucket: bucket,
            Key: fileName,
            Body: stream,
            ACL: 'public-read',
