...
import { searchLocationDetail} from '../redux/actions/apiActions';
...
class LocationBanner extends React.Component {
    ...
    googleMapService(placeId){
        ...
        //.then(this.setState({storePhoto: storePhoto}))
        ...
        return (
                <Row className='locationDetail'>
                    <div style={{height: 350, marginTop: -25, backgroundImage: this.state.storePhoto ? `url(${this.state.storePhoto})` : "", backgroundSize: 'cover', position: 'relative', marginBottom: 25, backgroundPosition: 'center'}}>
                        <div className='locationDetail-cover' style={{position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'rgba(0, 0, 0, 0.7)'}}>
                        </div>
                        <div className='locationDetail-desc'>
                            <div>
                                ...
                                <div style={{marginTop: 30}}>
                                    <div className='desc-item' style={{display: 'inline-block', width: 180}}>
                                    ...
                                    <div  className='desc-item' style={{display: 'inline-block', marginLeft: 30, width: 180}}>
                                        <Button id='likeCount' retainBackground rounded bsStyle='orange75' active={this.state.likeActive}>
                                ...
                                <div style={{marginTop: 9}}>
                                    <div sclassName='desc-item' style={{display: 'inline-block', width: 180}}>
                                        <Button id='likeCount' retainBackground rounded bsStyle='orange75' active={this.state.likeActive}>
                                    ...
                                    <div sclassName='desc-item' style={{display: 'inline-block', marginLeft: 30, width: 180}}>
                                        <Button id='likeCount' retainBackground rounded bsStyle='orange75' active={this.state.likeActive}>
